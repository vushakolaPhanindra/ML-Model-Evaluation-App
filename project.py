...
st.write("Upload any CSV dataset (up to 1.2 GB) and explore how different machine learning models perform in predicting your target variable.")
# Sidebar settings
...
uploaded_file = st.file_uploader(
    "Upload CSV file (up to ~1.2 GB supported)",
    type=["csv"]
)
